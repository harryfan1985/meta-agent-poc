...
| 结构化模型 provider | **Anthropic/OpenAI 官方 Python SDK + OpenAI-compatible base URL** | B | 只作为 `StructuredLLM` adapter;Stage/Runtime 只看 `generate(system,user,json_schema)->dict` |
